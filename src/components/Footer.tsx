        ...
        <div className="grid md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a href="#menu" className="hover:text-red-400 transition-colors">Cardápio</a>
              </li>

              <li>
                <a href="#sobre" className="hover:text-red-400 transition-colors">Nossa História</a>
              </li>

              <li>
                <a href="#localizacao" className="hover:text-red-400 transition-colors">Localização</a>
              </li>
            </ul>
          </div>
